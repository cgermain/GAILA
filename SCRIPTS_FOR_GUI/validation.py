...
def validate_check_for_final_product(form):
	...
	try:
		...
		#print "NormalizeIntensitites: " +  form["normalizeIntensities"]

		#mgf_read_dir_path = form["mgfReadDirPath"]
		#print "Intensity path: " + mgf_read_dir_path+"\intensity_summary.txt"
		#if os.path.isfile(mgf_read_dir_path+"\intensity_summary.txt"):
		#	print "intensity file already exists"
		#	return False, "intensity file already exists, probably as a remnant of a previous run.  This can be deleted and regenerated on the next run."
